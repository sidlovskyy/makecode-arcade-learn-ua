      ...
      steps: [
        ...
        },
        {
          ...
          visual: {
            ...
            explanation: 'У полі праворуч від замка задай висоту 12. Числа внизу задають розмір карти у тайлах. Підлогу й перегородки обери з Gallery. У блоковому зразку далі є рамка та три перегородки з проходами; це один можливий лабіринт.',
          },
          title: 'Збільш світ',
          instruction:
      ...
      steps: [
        {
          ...
          visual: {
            ...
            focus: { x: 0.022, y: 0.937, width: 0.027, height: 0.031, label: 'Почни з ширини карти: 30 тайлів.' },
            explanation: 'У полі праворуч від замка задай висоту 8. Знімок показує інструмент, а не готовий рівень. Познач землю й три платформи як wall. Старт, місце кристала, лаву й двері зроби окремими прохідними тайлами над землею. У наступному зразку: старт (2, 6), кристал (13, 2), двері (27, 6); лава над землею у стовпцях 9–10 і 22–24.',
          },
